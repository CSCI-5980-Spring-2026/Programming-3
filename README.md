# Programming 3: Game Loop and Real-Time Simulation

In this live programming class, we will add a high-resolution clock to the main game loop, implement the core class structure to begin constructing a scene graph, and integrate the [OpenGL Mathematics (GLM)](https://github.com/g-truc/glm) library.
